...
| `system.js` | Thin router (~156 lines) — delegates 72 actions to 23 files in `lib/actions/` |
...
# Tests
npm test                             # Vitest — auth, rate-limit, profit, routing, CSV parser, image validation, import-guard, contracts (54 tests)
```
