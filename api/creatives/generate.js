...
She is barefoot on a quiet beach, ocean behind her, bright clean sky. TIME OF DAY — THIS IS CRITICAL: bright mid-afternoon, around 2-3 PM. The sun is high in the sky, slightly forward of the model so it lights her face, body and the swimsuit from the front — NOT a low evening side-angle, NOT golden hour, NOT directly overhead at noon. Bright clean afternoon daylight (sky is hazy/lightly bright, NOT a hard blue cloudless midday), so the light is naturally diffused and even. The model is FACING the sun (and the camera) — her own short shadow falls back behind her on the sand, never across her body. The SWIMSUIT is the hero of this photo and must be evenly, fully, brightly lit — every part of it clearly visible and crisply readable: fabric texture, exact color and pattern, ribbing/pleating, trims, stitching, seams, waistband. ZERO shadows on the swimsuit — not under the bust, not at the waistband, not in the folds, not cast by her arms. Both her left and right side are equally lit, neither leg is darker than the other. The garment is fully exposed and bright; if any part of it sinks into shadow, or one side of the body is darker than the other, the lighting is WRONG. True blacks that still show fabric detail (not crushed to pure black). NOT a gloomy grey day, NOT dark, NOT moody, NOT golden-hour, NOT side-lit, NOT high-noon harsh.
...
LIGHTING — READ THIS: bright mid-afternoon sun (around 2-3 PM), high in the sky and slightly in front of the model so she is front-lit, hazy-bright clean diffused daylight. NOT golden hour, NOT a low side-angle sun, NOT high-noon overhead, NOT moody. The swimsuit is evenly and fully lit, both sides of the body equal, every detail readable, NO shadows on it.

${framingReminder}

${catalogFinalCheck}

NEGATIVE: ${catalogNegativePrefix}side lighting, light from the side, side-angle sun, rim light, backlight, backlit, silhouette, sun behind the model, harsh high-noon sun, hard direct overhead sun, hard cast shadows, shadow across the front of the body, asymmetric lighting, one side of the body in shadow, shadow falling on one leg, dark stripe down the side of the body, deep shadows on the swimsuit, dark areas on the garment, swimsuit lost in shadow, underlit swimsuit, crushed blacks, garment crushed to pure black, dramatic lighting, moody lighting, gloomy grey day, dark photo, underexposed, heavy orange filter, oversaturated sunset, sunset, plastic skin, porcelain smoothing, AI face, blurry face, smooth featureless skin, doll eyes, slim body, flat stomach, thigh gap, text, watermarks${framingNegative}.`.trim();
