...
async function handler(req, res) {
  ...
  try {
    ...
    if (isProductCatalog) {
      ...
      void framingText;
      const framingBlock = `\n\n━━━━━━━━━━━━━━━━━━━━━━━━\n=== FRAMING — 4:5 THREE-QUARTER PORTRAIT ===\nThree-quarter (3/4) body 4:5 vertical portrait. The frame extends from a small margin of sky/background ABOVE the top of her head down to her MID-CALF (the middle of the lower leg, between the knee and the ankle). The model's HEAD is fully visible with breathing room above. The KNEES are visible. The MID-CALF is the BOTTOM EDGE of the frame. The ANKLES are NOT in the frame. The FEET are NOT in the frame. There is NO sand at her feet because her feet are below the frame. The model occupies the FULL height of the frame from her head down to her mid-calf, filling roughly 85-95% of the vertical space. If you can see her ankles or feet, the framing is WRONG — crop tighter (push the bottom edge up to mid-calf). If her head is cropped at the top of the frame, the framing is WRONG — give her breathing room above.\n━━━━━━━━━━━━━━━━━━━━━━━━`;
