...
She is barefoot on a real beach, standing on sand. Behind her is a CLEARLY VISIBLE beach scene: ocean with gentle waves, wet and dry sand, a soft pale-grey overcast sky with subtle cloud texture and a low horizon line. It looks like an actual photo taken at the beach on a cloudy day — NOT a featureless white blur, NOT a blown-out empty background, NOT studio fog. The background is softly out of focus (shallow depth of field, model tack sharp) but it is unmistakably a beach: you can see the sea, the sand, the horizon.

━━━━━━━━━━━━━━━━━━━━━━━━
=== LIGHTING — READ CAREFULLY, DO NOT SKIP THIS ===
WEATHER & LIGHT TYPE: a bright OVERCAST day — the sky is a soft, bright pale-grey with gentle cloud texture (NOT clear blue, NOT a hard sunny day, but ALSO not a blank white void — it still looks like sky). There is NO visible sun, NO direct sunbeam, NO golden hour, NO sunset. The cloud cover acts like one giant softbox: the light on the model is FLAT, SOFT, and comes EVENLY from everywhere at once. Because there is no single light source, there are NO directional cast shadows — no shadow stretching off to one side, no dark side of the body, no hard shadow on the sand, no shadow under the bust, no shadow on either leg. Bright but soft, like a professional shoot done outdoors under a huge diffuser.

EXPOSURE: the MODEL and SWIMSUIT are BRIGHT — high-key, airy, well-lit, never dim, never dark, never moody. Black fabric reads as a rich dark grey-black with the ribbed texture / pleating / seams clearly visible — NOT crushed to a flat black silhouette. The BACKGROUND is also properly exposed — visible sea, sand and clouds — NOT blown out to pure white, NOT a foggy haze.

THE GARMENT: the SWIMSUIT is the hero of this photo and must be evenly, fully, brightly lit — every part clearly visible and crisply readable: fabric texture, exact color and pattern, ribbing/pleating, trims, stitching, seams, waistband. The LOWER HALF (briefs / bottoms / skirt) is lit just as brightly as the top — it does NOT fall darker. ZERO shadows on the swimsuit. If any part of the garment sinks into shadow, the sky looks clear-blue-sunny with a directional shadow, OR the background is a featureless white blur, the result is WRONG — bright soft overcast day, flat even light on the model, real beach visible behind.
━━━━━━━━━━━━━━━━━━━━━━━━
