...
THE GARMENT: the SWIMSUIT is the hero of this photo. It is lit by direct front sunlight and is well-lit and clearly readable — never dim, never grey-flat, but also never blown out: fabric texture, exact color and pattern, ribbing/pleating, trims, stitching, seams, waistband all crisply visible. Black fabric reads as a rich dark grey-black with all the ribbed / pleated texture catching the light — NOT crushed to a flat black silhouette, NOT a washed-out grey. The swimsuit is exposed a touch BRIGHTER than a perfectly neutral exposure — the shadows on the fabric are lifted, so even the deepest folds and the underside of the bust stay readable. The LOWER HALF (briefs / bottoms / skirt) is lit just as brightly as the top — it does NOT fall darker. ZERO hard shadows on the swimsuit. (This applies to the GARMENT and model — it does NOT change the scene: the sky stays a bright blue with soft clouds, the sun stays behind the camera, the background stays a properly-exposed real beach with full detail, not blown out to white.) If any part of the garment sinks into shadow, OR a hard directional / side-lit shadow appears on the body / garment / sand, OR the background / model is overexposed and washed out to white, OR the background is a gloomy dark grey, the result is WRONG.
...
LIGHTING — READ THIS: bright direct frontal sunlight on the model and product (the sun is behind the camera) — well-lit and clearly readable, natural balanced exposure, NOT dim and NOT overexposed/washed out. Subtle warm light. Only SOFT NATURAL shadows — NO hard side-lit / directional shadow on the product, body, or sand. Bright BLUE sky with a few soft white clouds, light haze at the horizon, background holds full detail (NOT blown out to white). Warm, clean grade — NOT cool/grey, NOT a heavy orange filter, NOT washed-out, NOT moody, NOT a heavy grey overcast. Black fabric shows texture, not crushed black.
${framingBlock}
