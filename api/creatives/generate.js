...
async function handler(req, res) {
  ...
  try {
    ...
    if (isProductCatalog) {
      ...
      void framingText;
      const framingBlock = `\n\n━━━━━━━━━━━━━━━━━━━━━━━━\n=== FRAMING — 4:5 ABOVE-KNEE PORTRAIT ===\nThree-quarter 4:5 vertical portrait. The frame extends from a small margin of sky/background ABOVE the top of her head down to JUST ABOVE her knees (mid-thigh / above the kneecap). The model's HEAD is fully visible with breathing room above. The FEET are NOT in the frame. The LOWER LEGS, KNEES, and CALVES are NOT in the frame — the frame BOTTOM EDGE sits at the top of the kneecap or just above it. The model occupies the FULL height of the frame from her head down to her upper thigh, filling roughly 80-90% of the vertical space. The garment must be fully visible within this above-knee crop (top of head → upper thigh). If you can see her knees, lower legs, calves, ankles, or feet, the framing is WRONG — crop tighter. If her head is cropped at the top of the frame, the framing is WRONG — give her breathing room above.\n━━━━━━━━━━━━━━━━━━━━━━━━`;
      const framingNegative = ', head cropped, top of head cut off, full body shot, visible feet, visible ankles, visible calves, visible knees, full legs, lower legs in frame, knees in frame, calves in frame, feet in frame, head-to-toe shot, full-length portrait, model standing in full body view';
