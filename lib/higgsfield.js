...
${age_desc} wearing the product on a beach. Warm golden hour color temperature.
LIGHTING: Sun is BEHIND the camera, illuminating the model and product FROM THE FRONT. The product must be fully lit, bright, and clearly visible — NOT backlit, NOT silhouetted. Warm front-facing light that shows every fabric detail and color.
