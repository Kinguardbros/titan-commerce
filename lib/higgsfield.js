...
Output: 1080x1080, photorealistic, no text overlay.`.trim();
  ...
  // Text overlay
  if (textOverlay === 'none') {
    prompt += '\n\nCRITICAL: Do NOT add ANY text, words, letters, numbers, watermarks, logos, branding, brand names, labels, or typography anywhere in the image — not on the product, not on the background, not floating. The product must have NO visible branding, logos, or text printed on it. The image must be completely text-free and brand-free. Clean product only.';
