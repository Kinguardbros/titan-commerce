...
Output: 1080x1080, photorealistic, no text overlay.`.trim();
  ...
  // Product fidelity — force matching the reference image
  prompt += `\n\nCRITICAL: The product in the generated image MUST look EXACTLY like the product in the reference image. Same design, same pattern, same colors, same cut, same details. Do NOT create a new product — recreate THIS EXACT product on the model/in the scene. The reference image shows the real product — match it precisely.`;
