...
Output: 1080x1080, photorealistic, no text overlay.`.trim();
  ...
  // Text overlay
  if (textOverlay === 'none') {
    prompt += '\n\nCRITICAL: Do NOT add ANY text, words, letters, numbers, watermarks, logos, or typography to the image. The image must be completely text-free. NO text overlay whatsoever.';
