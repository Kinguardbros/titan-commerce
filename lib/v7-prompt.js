...
// User wants the v5 lighting style (frontal flat strobe, neutral subject) but with a
// MORE BALANCED, NATURAL-LOOKING look — warm afterglow background that's clearly
// VISIBLE (not dim/muted like v5), ocean has soft creamy bokeh, sky has visible warm
// tone, but exposure is balanced (subject just slightly brighter than background, not
// dramatically). The look is closer to a "natural late afternoon" beach catalog shoot
// than v5's "dim post-sunset" or v6's "vivid bright midday."
// Same NSFW-safe vocabulary as v5/v6 (no body/skin/torso triggers).
// Difference vs v5: SETTING (visible warm afterglow not dim), EXPOSURE (balanced not
// dramatic), COMPOSITION (moderate DOF f/2.5-f/3.5), COLOR GRADING (visible warm not
// heavily muted).
// Same as v5: WARDROBE, POSE, LIGHTING, PHOTOGRAPHIC STYLE, QUALITY structure.
export const V7_PROMPT_BODY = `Editorial product photograph for a premium swimwear e-commerce catalog. Vertical 4:5 aspect ratio.
