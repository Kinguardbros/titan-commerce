...
An open beach during the SOFT AFTERGLOW just after sunset — the sun is already BELOW the horizon (NOT visible in the frame, NO solar disk, NO direct sunbeams) but the sky and atmosphere still hold a faint warm tint. Heavily DESATURATED, MUTED background — a soft hazy color wash, NOT a clear scene with vibrant elements. Pale washed-out cream sand in the foreground, very softly out of focus, almost abstract. Gentle DESATURATED soft blue-grey ocean waves visible behind her in the middle ground, very softly out of focus with natural motion (NOT vibrant turquoise, NOT saturated). Muted warm sky in the upper third of the frame — pale dusty peach softly blending into soft hazy blue-grey at the top, low contrast, low saturation, washed out, with maybe a few barely-visible thin clouds, NO visible sun, NO harsh sun, NO sunbeams, NO lens flare, NO vibrant gradient bands. The horizon line of the ocean is visible behind her but very GENTLY BLURRED, sitting at approximately bust to mid-torso height in the frame.

The beach environment is clean and uncluttered — no other people visible, no beach umbrellas, no chairs, no debris. Just sand, ocean, sky — all heavily blurred, all heavily muted, the warm afterglow is a feeling, not a vibrant color statement.
...
The model is tack sharp and in clear focus from head to thigh. The beach background is HEAVILY out of focus with strong creamy bokeh on the ocean and sand — VERY shallow depth of field, approximately f/1.4 to f/2 quality. The background reads as a soft abstract color wash — recognizable as a beach but with NO sharp detail, NO crisp edges, NO defined wave shapes, NO sharp horizon line. The horizon line is dissolved into the soft blur. The contrast between the sharp model and the dreamy out-of-focus background is what makes the product POP as the unmistakable focal point.
...
MUTED warm-ambient color grading with NEUTRAL subject — the BACKGROUND (sky, sand, ambient light) reads as a soft DESATURATED warm haze, but the MODEL and SWIMSUIT read in TRUE-TO-LIFE neutral color (NOT warm-shifted on the skin, NOT orange-skin, NOT warm-cast on the swimsuit fabric). Skin tones read true-to-life with healthy natural pinks in the cheeks preserved. Sand reads as washed-out pale cream (NOT vibrant gold, NOT saturated, NOT yellow — just a soft muted cream haze). Ocean reads as DESATURATED soft blue-grey with a hint of teal (NOT vibrant turquoise, NOT tropical blue, NOT saturated postcard blue — just a soft muted blue-grey wash). Sky reads as DESATURATED soft pastel peach blending into hazy soft blue-grey at the top (NOT vibrant peach, NOT saturated pink, NOT dramatic gradient — just a soft muted afterglow haze with low contrast, low saturation).
