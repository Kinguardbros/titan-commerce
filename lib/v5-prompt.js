...
SETTING:
An open beach during the soft afterglow just after sunset — the sun is already BELOW the horizon (NOT visible in the frame, NO solar disk, NO direct sunbeams) but the sky and atmosphere still hold a faint warm tint. MUTED, softly desaturated background — a soft hazy color wash. Pale washed-out warm cream sand in the foreground, softly out of focus. Gentle muted soft blue-grey ocean waves visible behind, softly out of focus (NOT vibrant turquoise, NOT saturated). Muted warm sky in the upper third — pale dusty peach softly blending into soft hazy blue-grey, low contrast, low saturation, washed-out, NO visible sun, NO sunbeams, NO lens flare. Horizon line visible as a very gentle gradient.
...
EXPOSURE:
The subject is exposed correctly by the strobe — bright, clear, and well-defined. The background is slightly UNDEREXPOSED relative to the subject — the beach, ocean, and sky appear soft and notably DIMMER than the subject. This subtle exposure difference creates the "studio shoot on location" look — the subject is unmistakably the BRIGHTEST, most exposed, most clearly defined element in the frame, while the background reads as a soft dim color wash that supports without competing. The garment must POP against the dimmer warm afterglow background. NOT silhouetted (subject brighter than background, never the reverse).

COMPOSITION & FRAMING:
Vertical 4:5. Subject positioned center frame horizontally, occupying the central 55-65 percent of the vertical frame. Generous negative space above the head (sky, soft background) for potential text overlay. Frame includes the full figure from top of head down through mid-thigh or knee depending on swimsuit type. Subject is tack sharp and in clear focus. Background heavily out of focus with creamy bokeh — shallow depth of field approximately f/2 to f/2.8 quality.
