...
An open beach during the SOFT AFTERGLOW just after sunset — the sun is already BELOW the horizon (NOT visible in the frame, NO solar disk, NO direct sunbeams) but the sky and atmosphere still hold a soft warm tint. Gently DESATURATED, soft-toned background — a warm hazy afterglow scene with subtle but visible color presence (NOT vibrant, NOT saturated, BUT readable as a real beach scene with visible warm afterglow color). Soft warm cream sand in the foreground, softly out of focus. Gentle softly saturated soft warm blue ocean waves visible behind her in the middle ground, softly out of focus with natural motion (NOT vibrant turquoise, NOT tropical postcard blue, BUT clearly blue). Warm soft sky in the upper third of the frame — pale peach softly blending into soft warm blue at the top, gentle contrast, moderate saturation, soft and warm with visible color presence, with maybe a few barely-visible thin clouds, NO visible sun, NO harsh sun, NO sunbeams, NO lens flare, NO vibrant gradient bands. The horizon line of the ocean is visible behind her as a gentle gradient, sitting at approximately bust to mid-torso height in the frame.

The beach environment is clean and uncluttered — no other people visible, no beach umbrellas, no chairs, no debris. Just sand, ocean, sky — all softly blurred, gently muted but with visible warm afterglow color presence.
...
- BRIGHT, EVEN, DIMENSIONAL FRONT ILLUMINATION on her face and body, noticeably brighter and CRISPER than the natural ambient afterglow light. The strobe is clean, punchy, and well-defined — the model is unmistakably lit, with subtle highlights and clean shadow shaping that make the body and product POP. She is clearly "lit from the front" by an artificial light source.
...
- EVEN, FLAT FRONT-FILL on the model and garment — soft frontal lighting wraps gently across the figure with no harsh shaping shadows on the fabric. The garment color reads uniformly across its entire surface. Subtle highlights on the front from the strobe.
...
The model is tack sharp and in clear focus from head to thigh. The beach background is softly out of focus with creamy bokeh on the ocean and sand — shallow depth of field, approximately f/2 to f/2.8 quality. The background reads as a soft impressionistic beach scene — recognizable as a beach with the horizon line visible as a gentle gradient, NO sharp detail on waves, NO crisp edges. The contrast between the sharp model and the dreamy softly out-of-focus background is what makes the product POP as the unmistakable focal point.
...
Softly warm-ambient color grading with NEUTRAL subject — the BACKGROUND (sky, sand, ambient light) reads as a gentle warm afterglow with visible color presence (warm but soft, NOT vibrant, NOT washed-out), but the MODEL and SWIMSUIT read in TRUE-TO-LIFE neutral color (NOT warm-shifted on the skin, NOT orange-skin, NOT warm-cast on the swimsuit fabric). Skin tones read true-to-life with healthy natural pinks in the cheeks preserved. Sand reads as soft warm cream (NOT vibrant gold, NOT washed-out grey — a clean warm cream with visible warmth). Ocean reads as softly saturated soft warm blue with a hint of teal (NOT vibrant turquoise, NOT tropical postcard blue, BUT clearly blue — not muted to grey). Sky reads as softly saturated soft warm peach blending into soft warm blue at the top (visible color, NOT washed out, NOT vibrant gradient bands — gentle saturation with moderate contrast).

Slight lift in the highlights for a soft luminous quality. Shadows preserved with detail — never crushed to pure black. The MODEL and SWIMSUIT are the only sharp, saturated, fully-exposed elements in the frame; the background is a SOFT DESATURATED MUTED color wash that supports without competing. The contrast between the muted background and the clean neutral subject is what makes the swimsuit POP as the focal point. Overall image has a gentle, premium editorial feel — soft warm haze in environment, clean on the subject.
...
- Vibrant or saturated background colors (sky, ocean, sand) — background MUST be muted and desaturated
...
- Defined horizon line — horizon should be a soft gradient, not a sharp line
- Vibrant turquoise or tropical blue ocean — ocean should be desaturated soft blue-grey
- Vibrant peach or pink or yellow sky gradient — sky should be muted pastel haze
- A background that competes with the subject for attention — background is ONLY a soft supporting backdrop
- Excessively washed-out background — background should be muted but still readable, with visible warm afterglow color
- Flat lifeless light on the model — strobe must be crisp, clean, punchy, and well-defined`;
