...
SETTING:
An open beach during the soft afterglow just after sunset — the sun is already BELOW the horizon (NOT visible in the frame, NO solar disk, NO direct sunbeams) but the sky and atmosphere still hold a soft warm tint. Gently desaturated, soft-toned background. Soft warm cream sand in the foreground, softly out of focus. Gentle softly-saturated soft warm blue ocean waves visible behind her, softly out of focus (NOT vibrant turquoise). Warm soft sky in the upper third — pale peach softly blending into soft warm blue, gentle contrast, moderate saturation, NO visible sun, NO sunbeams, NO lens flare. Horizon line visible as a gentle gradient.
...
EXPOSURE:
The subject is exposed correctly by the strobe — bright and clear. The background is exposed only slightly softer than the subject — NOT dramatically darker, NOT silhouetted. Gentle contrast between subject and background.
...
COLOR GRADING:
Softly warm-ambient color grading with NEUTRAL subject — the BACKGROUND (sky, sand, ambient light) reads as a gentle warm afterglow with visible color presence (warm but soft, NOT vibrant, NOT washed-out). The garment reads in TRUE-TO-LIFE neutral color (NOT warm-shifted, NOT orange-cast, NOT washed-out). Sand reads as soft warm cream. Ocean reads as softly saturated soft warm blue with a hint of teal. Sky reads as softly saturated soft warm peach blending into soft warm blue. NO heavy contrast, NO HDR look, NO over-sharpening, NO oversaturated colors, NO Instagram filter aesthetic.
