...
NAVEL COVERAGE — MANDATORY:
The swimsuit waistband sits HIGH at the natural waist, completely covering the belly button. The navel is NEVER visible — the fabric extends UP from the bottoms to fully cover the midsection. For two-piece swimsuits the bottoms waistband is HIGH-RISE and reaches the natural waist (just below the ribcage), with NO bare midriff between the top and the bottoms when the model stands neutrally. For one-piece swimsuits the fabric covers the entire torso from bust to upper hip with no cutouts at the navel. If the navel is visible in any way (a peek, a sliver, a partial outline), the result is WRONG — the fabric must be raised to cover it fully.
...
EXPOSURE:
HIGH-KEY exposure — bright, airy, summery beach catalog feel where BOTH the subject AND the background are well-lit and bright together. The subject (model + garment) is brightly exposed with clean bright skin tone on the FACE, NECK, SHOULDERS, ARMS, and LEGS, fully lit garment fabric showing every construction detail, and rich highlight detail. The garment fabric covers the entire midsection (chest down through hip/upper thigh) — the navel and lower torso are NOT bare skin, they are covered by the swimsuit fabric. The background (sand, sky, ocean) is also bright and clearly visible with full natural detail — bright cream sand, bright clear blue sky with soft white clouds, bright blue-teal ocean. Low contrast overall, airy and bright. The subject is never overexposed, never blown out, never washed out — just bright and crisp. Black fabric reads as a rich dark grey-black with the ribbed texture / pleating / seams clearly visible — NOT crushed to a flat black silhouette. NOT a dim or moody exposure, NOT a dark gloomy beach, NOT silhouetted — this is bright midday beach catalog photography.
