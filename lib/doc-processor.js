    ...
    const response = await anthropic.messages.create({
      ...
      messages: [{
        ...
        content: [
          ...
          { type: 'text', text: 'Extract ALL text content from this document. Return the full text, preserving structure (headings, bullet points, tables). If it contains a table, format as CSV.' },
        ],
      }],
    });
