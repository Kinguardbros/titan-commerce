...
export async function kpi(req, res) {
  ...
  // No store_id in this action (cross-store KPI aggregate) — no store to check against.
...
export async function meta_overview(req, res) {
  ...
  // No store_id in this action (Meta account-level overview) — no store to check against.
