...
FACE DETAIL (CRITICAL — high-priority, this is the most important quality marker):
- VISIBLE SKIN PORES across the entire face, especially on the nose, forehead, and cheeks. Pores are clearly resolved, not smoothed away.
- NATURAL SKIN TEXTURE — visible micro-irregularities, subtle blotches, faint redness around the nose and chin, real human skin variation. NOT a uniform tone.
- INDIVIDUAL EYEBROW HAIRS visible, not painted-on shapes. Eyebrows have natural irregularity — some thinner spots, some thicker, NOT perfectly groomed.
- INDIVIDUAL EYELASHES visible, natural length variation, NOT mascara-thick.
- FINE LINES around the eyes (small wrinkles at the outer corners when relaxed), small expression lines around the mouth (faint nasolabial folds for women 30+). For age 40+, also subtle forehead lines.
- LIPS have natural texture — visible vertical lip lines, slight unevenness in color, dry/matte finish (NOT glossy, NOT plumped, NOT filtered).
- NATURAL ASYMMETRY — one side of the face is slightly different from the other (real faces are NEVER perfectly symmetrical). One eye slightly more open, one corner of mouth slightly higher, jawline subtly uneven.
- SUBTLE IMPERFECTIONS — at least 2-3 of: small mole, freckle, faint scar, small pimple/blemish, slight dark circle under eye, faint redness on nose, visible blood vessels on eyelid, dry patch.
- HAIR shows individual strands at the hairline, slight frizz, natural part imperfections, NOT a glossy hair-commercial finish.
- NO airbrushing, NO Instagram filter, NO beauty smoothing, NO HD ready-for-camera polish. This is a phone snapshot of a real human, not a professional headshot.
