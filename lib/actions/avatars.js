...
export async function generate_avatar(req, res) {
  ...
  const remainingAngles = [
    'Show the EXACT SAME woman from the reference image, now from the back. Back view, facing away from camera, looking over right shoulder. Same hair, same skin, same body. Wearing the same BEIGE/NUDE skin-toned underwear — NOT black. FULL BODY shot from head to bare feet — entire body visible with feet at the bottom of the frame. Do NOT crop at the knees.',
    'Show the EXACT SAME woman from the reference image, now from the left side. Left profile view. Same hair, same skin, same body. Wearing the same BEIGE/NUDE skin-toned underwear — NOT black. FULL BODY shot from head to bare feet — entire body visible with feet at the bottom of the frame. Do NOT crop at the knees.',
    'Show the EXACT SAME woman from the reference image, now from the right side. Right profile view. Same hair, same skin, same body. Wearing the same BEIGE/NUDE skin-toned underwear — NOT black. FULL BODY shot from head to bare feet — entire body visible with feet at the bottom of the frame. Do NOT crop at the knees.',
  ];
