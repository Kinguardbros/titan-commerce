...
- Wearing a simple neutral tank top and shorts (NOT swimwear) so her body shape is visible
...
The goal is to create a RECOGNIZABLE reference model that will be used consistently across product photos.`;
  ...
  // Use Nano Banana 2 for better quality (works without reference for text-to-image too)
  const variantPromises = Array.from({ length: 4 }, () =>
    generateFal({ model: 'fal-ai/nano-banana-2/edit', prompt, numImages: 1, aspectRatio: '4:5' })
  );
