...
CLOTHING: Beige seamless fit-test set — a simple fitted seamless beige top (camisole/bralette style with thin straps, full coverage over the bust, smooth opaque fabric) and matching seamless beige high-waisted bottoms (briefs cut, sitting at the natural waist well above the navel, full coverage over the hips and pelvis). Solid uniform beige / nude / sand color (NOT white, NOT cream, NOT pink — a true muted beige skin-neutral). Smooth seamless fabric, no patterns, no graphics, no logos, no lace, no mesh, no cutouts, no see-through panels — fully OPAQUE matte fabric. Bare feet, no shoes. The set fits closely so her real body proportions are clearly visible, while keeping full modest coverage across the chest and pelvis.
...
CLOTHING: Beige seamless fit-test set — simple fitted seamless beige top (camisole/bralette with thin straps, full bust coverage) + matching seamless beige high-waisted bottoms (briefs cut, sitting at the natural waist above the navel, full pelvis coverage). Solid muted beige / nude / sand color (NOT white, NOT cream, NOT pink). Smooth opaque seamless fabric — no patterns, no logos, no lace, no mesh, no cutouts. Bare feet.
