...
CLOTHING: Beige seamless fit-test set — TWO-PIECE: a bra-style top (seamless beige bralette with thin shoulder straps, scoop neckline, ENDING JUST BELOW THE BUST so the midriff and rib cage are bare and visible — NOT a tank top, NOT a camisole, NOT a tight tee, NOT a long top that reaches the waist; the entire torso between the bottom of the bra and the top of the briefs is BARE SKIN showing). Plus matching seamless beige high-waisted briefs (sitting at the natural waist well above the navel, full coverage over the hips and pelvis). Solid uniform beige / nude / sand color (NOT white, NOT cream, NOT pink — a true muted beige skin-neutral). Smooth seamless opaque matte fabric on both pieces, no patterns, no graphics, no logos, no lace, no mesh, no cutouts, no see-through panels. Bare feet, no shoes. The set fits closely so her real body proportions are clearly visible, with a visible bare midriff between the bra and the briefs.
...
CLOTHING: Beige seamless fit-test set — TWO-PIECE: bra-style top (seamless beige bralette with thin shoulder straps, ENDING JUST BELOW THE BUST — NOT a tank top, NOT a camisole; the midriff between the bra and briefs is BARE SKIN visible) + matching seamless beige high-waisted briefs (sitting above the navel, full pelvis coverage). Solid muted beige / nude / sand color (NOT white, NOT cream, NOT pink). Smooth opaque seamless matte fabric — no patterns, no logos, no lace, no mesh, no cutouts. Bare feet.
