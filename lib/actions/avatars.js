...
FACE DETAIL (CRITICAL — high-priority, this is the most important quality marker. Read EVERY bullet carefully and apply ALL of them):

SKIN TEXTURE (highest priority):
- VISIBLE SKIN PORES across the ENTIRE face — especially dense on the nose (large visible pores), forehead, and cheeks. Pores are clearly resolved at pixel level. Different pore density in different zones (more on T-zone, less on outer cheeks).
- T-ZONE OILINESS — forehead, nose, and chin show subtle natural shine and slightly more visible pores than the cheeks (drier zones). The T-zone is NOT matte and uniform — it has subtle wetness/sheen that real human skin has.
- SKIN TONE VARIATION across the face — NOT a uniform single tone. Areas with subtle pink/red (cheeks, nose tip, chin, around mouth, eyelids). Areas with subtle yellow/tan (forehead, jawline). Faint hyperpigmentation patches. This must be VISIBLY uneven, not blended-flat.
- FAINT BLOOD VESSELS visible on eyelids and side of the nose — tiny pink/red capillary patterns showing through thin skin.
- SUBTLE REDNESS on the tip of the nose, around the nostrils, and at the inner corners of the eyes — natural irritation from real skin.

EXPLICIT IMPERFECTIONS (MUST include at least 4-6 of these visible in the image):
- 3-5 small natural moles or beauty marks (1-2mm) scattered across the face — typically near the eye, on the cheek, near the mouth, on the jawline, or on the neck.
- 5-10 visible freckles or sun spots, especially across the bridge of the nose and upper cheeks.
- 1-2 faint old scar marks (tiny, healed, barely visible) — common locations: eyebrow, chin, near hairline.
- Slight dark circles under both eyes (real human under-eye area, NOT photoshopped away).
- A small blemish or two — a healing spot, a tiny bump, a faint red mark on the chin or jaw.
- Dry patch on lip or corner of mouth.

LIP DETAIL:
- VISIBLE VERTICAL LIP LINES across both upper and lower lip — clearly resolved natural lip texture, NOT a smooth uniform surface.
- LIP COLOR UNEVEN — slightly darker at the edges, lighter toward the center, occasional small dry/flaky spots.
- MATTE FINISH — completely matte, NO gloss, NO sheen, NO plumped look. Dry-natural lips, NOT filtered.
- THIN VERMILION BORDER — natural lip outline, NOT a sharp drawn line.

EYE DETAIL:
- INDIVIDUAL EYELASHES — natural length variation, some shorter some longer, NO mascara-thick clumps.
- VISIBLE TEAR DUCTS — inner corners of eyes show natural pink/red moisture, not flat skin.
- SUBTLE REDNESS in the whites of the eyes — NOT pure white. Real human eye whites have faint pink/yellow tint and tiny blood vessels.
- VISIBLE LOWER LASH LINE imperfections — uneven density, some missing lashes here and there.

EYEBROW DETAIL:
- INDIVIDUAL EYEBROW HAIRS visible, growing in slightly different directions (NOT all combed perfectly the same way).
- Eyebrow shape has natural irregularity — thinner spots, fuller spots, asymmetric arch between left and right brow.
- Maybe 1-2 stray hairs above or below the main brow line.

LINES & AGING (apply per age):
- FINE LINES around the outer corners of the eyes (crow's feet) — even when neutral, faint lines are visible at age 30+, more visible at 40+.
- FAINT NASOLABIAL FOLDS (lines from nose to mouth corners) at age 30+, more defined at 40+.
- FOREHEAD HORIZONTAL LINES (1-3 faint) at age 40+.
- SUBTLE FROWN LINES between the eyebrows at age 35+.
- SMALL VERTICAL LINES on the upper lip at age 40+.

ASYMMETRY (real faces are NEVER symmetric):
- One eye slightly larger or more open than the other.
- One eyebrow sits slightly higher.
- One nostril subtly bigger.
- One corner of mouth slightly higher.
- Jawline subtly uneven left vs right.

HAIR DETAIL:
- INDIVIDUAL STRANDS visible at the hairline and along the part.
- Natural FRIZZ — small flyaway hairs, baby hairs at the hairline.
- Imperfect part — slightly uneven, not laser-straight.
- Slight variation in hair color (some lighter strands, some darker), NOT a uniform single color.
- NO glossy hair-commercial finish, NO blowout perfection.

ABSOLUTELY DO NOT: airbrush, smooth, filter, FaceTune, beautify, polish, idealize, or remove any imperfection. This is a phone snapshot of a real human as she truly is — every pore, every line, every blemish stays.
