...
export async function generate_avatar(req, res) {
  ...
  const prompt = fullDescription.startsWith('Professional') || fullDescription.startsWith('Full body')
    ? fullDescription
    : `Full body reference photograph of a ${age}-year-old woman standing in front of a plain wall at home. Natural amateur photo, not a professional shoot. ${bodyDetails}. FULL BODY shot — head to bare feet fully visible, feet at the bottom of the frame. Do NOT crop at the knees or waist. She is a regular ${age}-year-old woman, average height and build, neither a model nor particularly photogenic. Wearing plain nude/skin-toned matching underwear set — simple nude bra and nude briefs, no patterns, no lace, no decorations, matching her natural skin tone. Bare feet, no shoes. Arms relaxed at sides. Neutral indoor lighting, slightly uneven, like a normal hallway or bedroom. Plain beige or off-white wall background, no props, no furniture. Her face shows real age: skin pores, uneven skin tone, visible fine lines, slightly tired under-eye area${parseInt(age) > 45 ? ', some greying hair, loose skin around the jaw' : ''}. No makeup or minimal natural makeup, no styled hair, no posed smile. Subtly neutral expression — she is not posing, just standing for a reference photo. Photograph shows imperfect real skin texture with pores, freckles, uneven tone, stretch marks, natural body imperfections. Snapshot quality, plain and unremarkable. Do NOT make her look like a model, influencer, swimsuit catalog, or professional photo.`;
