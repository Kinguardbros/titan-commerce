...
export async function push_reviews_to_shopify(req, res) {
  ...
  refreshStoreReviewsAggregate(store, store_id).catch((err) => {
...
export async function refreshStoreReviewsAggregate(store, storeId) {
...
export async function refresh_store_reviews_aggregate(req, res) {
  ...
  const result = await refreshStoreReviewsAggregate(store, store_id);
