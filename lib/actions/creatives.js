  ...
  for (const c of pending) {
    ...
    try {
      ...
      if (result.status === 'completed' && result.url) {
        ...
        // Post-processing is disabled for ALL catalog styles — fal.ai returns native 4:5
        // and we store it as-is for consistent pixel dimensions. Optimistic flow: flip status
        // immediately with the fal.ai URL, upload to Storage in the background.
