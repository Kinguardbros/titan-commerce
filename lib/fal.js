 ...
 */
export async function generateFal({ model = 'fal-ai/nano-banana', prompt, imageUrl, numImages = 1, strength = 0.5 }) {
  ...
  return pollFalResult(model, request_id);
}

async function pollFalResult(model, requestId, maxTime = 55000) {
